...
|applicationId|string|*Required for all features**<br/><br/>Identifies the calling form with a verified application ID generated from the Square Application Dashboard|
